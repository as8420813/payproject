		...
		<div class="headerContent">
			...
			<div class="links">
				...
				<c:if test="${PORTAL_IS_REGISTER }">
					<a href="merchantRegister.action">注册</a>
				</c:if>
			</div>
			<div class="clear"></div>
		</div>
					...
					<div class="loginBox">
						...
						<div class="login opa">
							<form action="login_operatorLogin.action" method="post" >
	 								<div class="userwrap">
										<input type="text" name="loginname" value='${merchant.loginname}' class="input user ada-sp" />
									</div>
									<div class="passwordwrap">
										<span style='float:left;width:43px;'>&nbsp;&nbsp;&nbsp;</span>

										<input type="password" name="loginpwd" id="password" value='${merchant.loginpwd}' class="password" maxlength="20"/>
									</div>
									
									<div class="logintype" style="margin:10px;position:relative;left:12px">
									  登陆类型
									 <label><input name="logintype" type="radio" value="member" checked="checked"/>会员 </label> 
									 <label><input name="logintype" type="radio" value="merchant" />商户 </label>  
									
									</div>
										
									<div  style="*margin-left:30px;position:relative;left:22px">
										<input class="commonBtnLong btn_login" id="Button4" type="submit" value="登 录" />
