	...
	<form id="form1" action="merchantLookForLoginPwd_editLoginPwd.action"
		method="post">		
			...
			<input type="hidden" name="lookForType" value="${lookForType}" />
				...
				<p class="clearfix">
					<label>新密码：</label>
					<input id="lgnewPwd" type="password" name="lgnewPwd1" value="${newPwd1}" maxlength="20" style='width:268px'/> 
				</p>
				<p class="clearfix">
					<label>确认新密码：</label>
					<input id="lgnewPwd" type="password" name="lgnewPwd2" value="${newPwd2}" maxlength="20" style='width:268px'/>
				</p>
				<p class="clearfix">
					<label> &nbsp; </label>
