...
<body>
	...
	<form id="form1" action="validateRegister.action" method="post">
		...
		<div class="registerwrap">
			...
			<div class="content">
				...
				<div class="registerbox">
					<ul class="tabHead">
						<li><a href="memberRegister.action"> 个人账户</a></li>
						<li class="now"><a href="merchantRegister.action"> 企业账户</a></li>
					</ul>
					<div class="register">
