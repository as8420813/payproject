	...
	*/
	...
	/*简单粗暴重置默认样式===============================*/
		*{ margin: 0; padding: 0; }
		...
		.treebox{ width: 220px;  background-color:#1a6cb9; }
...
<body scroll="no">
	<div id="layout">
		...
		<ul class="menu">
			<li class="level1">
				<a class="load" href="#none"><em class="ico ico1"></em>系统管理<i class="up"></i></a>
				<ul class="level2">
					<li><a href="posMerchant_agentMerchantList.action" title="用户列表"  target="navTab">用户列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="角色列表"  target="navTab">角色列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="登录/退出日志"  target="navTab">登录/退出日志</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="操作日志"  target="navTab">操作日志</a></li>
				</ul>
			</li>
			
			<li class="level1">
				<a class="load" href="#none"><em class="ico ico2"></em>订单管理<i class="up"></i></a>
				<ul class="level2">
					<li><a href="posMerchant_agentMerchantList.action" title="支付订单查询列表"  target="navTab">支付订单查询列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="用户信息查询列表"  target="navTab">用户信息查询列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="撤单申请查询列表"  target="navTab">撤单申请查询列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="待退款处理查询列表"  target="navTab">待退款处理查询列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="待退款查询列表"  target="navTab">待退款查询列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="实时退款查询列表"  target="navTab">实时退款查询列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="已退款查询列表"  target="navTab">已退款查询列表</a></li>
				</ul>
			</li>
			<li class="level1">
				<a class="load"  href="#none"><em class="ico ico3"></em>商户对账管理<i class="up"></i></a>
				<ul class="level2">
					<li><a href="posMerchant_agentMerchantList.action" title="商户对账监控列表"  target="navTab">商户对账监控列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="商户对账历史监控列表"  target="navTab">商户对账历史监控列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="商户未对账支付订单查询列表"  target="navTab">商户未对账支付订单查询列表</a></li>					
				</ul>
			</li>
			<li class="level1">
				<a class="load" href="#none"><em class="ico ico4"></em>商户管理<i class="up"></i></a>
				<ul class="level2">
					<li><a href="posMerchant_agentMerchantList.action" title="商户列表"  target="navTab">商户列表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="商户审核列表"  target="navTab">用户信息查询列表</a></li>
					
				</ul>
			</li>
                        <li class="level1">
				<a class="load" href="#none"><em class="ico ico5"></em>报表管理<i class="up"></i></a>
				<ul class="level2">
					<li><a href="posMerchant_agentMerchantList.action" title="渠道交易量统计报表"  target="navTab">渠道交易量统计报表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="渠道交易量对比报表"  target="navTab">渠道交易量对比报表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="实名认证交易量统计报表"  target="navTab">实名认证交易量统计报表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="实名认证交易量对比报表"  target="navTab">实名认证交易量对比报表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="清算业务结汇总表"  target="navTab">清算业务结汇总表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="清算行业务明细表"  target="navTab">清算行业务明细表</a></li>
					<li><a href="posMerchant_agentMerchantList.action" title="监管行业务明细表"  target="navTab">监管行业务明细表</a></li>
				</ul>
			</li>
		</ul>
	</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){ 
		   ...
		   if(type=="up"){
		     ...
		     $(this).parent().siblings().find("i").attr("class", "up");
		   }else{
